        ...
        panel.webview.onDidReceiveMessage(
            async message => {
                switch (message.command) {
                    ...
                    case 'createTask':
                        try {
                            console.log("Extension - createTask message received");
                            ...
                            if (currentUserId === null) {
                                console.log("Extension - createTask: User not logged in");
                                panel.webview.postMessage({
                            ...
                            console.log("Extension - createTask: Attempting to insert task into database");
                            ...
                            if (error) {
                                console.log("Extension - createTask: Database error:", error);
                                panel.webview.postMessage({
                                    command: 'createTaskResult',
                                    success: false,
                                    error: error.message
                            ...
                            console.log("Extension - createTask: Task created successfully:", data);
                            panel.webview.postMessage({
                                command: 'createTaskResult',
                                success: true,
                                data: data
                            ...
                            console.log("Extension - createTask: Unexpected error:", error);
                            panel.webview.postMessage({
                                command: 'createTaskResult',
                                success: false,
                                error: error.message
